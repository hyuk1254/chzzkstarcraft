...
<style>
    ...
    .broadcast-team-card {
        background-color: #14161d; border: 2px solid #2d3139; border-radius: 16px; 
        padding: 20px; flex: 1 !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.4);
    }
...
with tab_main:
    ...
    # 1. 1층: [1팀 멤버] 와 [2팀 멤버] 묶음 박스 (HTML Flex로 가로 무조건 고정)
    left_team_html = ""
    ...
    # 3. 3층: [사진 아래 이름] 형태 및 가운데 정보 수직 정렬 매치보드 (HTML 강제 연산식)
...
# =========================================================
# 📝 [2번 탭] 실시간 대진 지명 및 대진 현황 (텍스트 최적화 모드)
# =========================================================
if not broadcast_mode:
    with tab_draft:
